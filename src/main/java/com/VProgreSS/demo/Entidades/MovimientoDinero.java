...
public class MovimientoDinero {
    ...
    public MovimientoDinero(Long idTransaction, String conceptTransaction, float amountTransaction, Empleado empleadoTransaction, Empresa empresaTransaction, java.sql.Date createdAtTransaction, Date updatedAtTransaction) {
